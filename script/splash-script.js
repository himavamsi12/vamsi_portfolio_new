...
function init() {
  ...
  loadImage("/spotlight-images/hero-image.png", topTexture, topTextureSize);
  loadImage("/spotlight-images/hero-new-image.png", bottomTexture, bottomTextureSize);
  ...
  function loadImage(url, targetTexture, textureSizeVector) {
    ...
    img.onload = function () {
      ...
      if (url.includes("hero-image.png")) {
